...
<template>
	<div class="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
				...
				<div class="flex justify-between h-16 items-center">
					...
					<div class="hidden md:flex items-center space-x-6">
						...
						<div v-if="page.props.auth.user" class="relative">
							<button id="user-menu-button" @click.stop="toggleUserMenu"
							...
							<!-- MENU -->
							<div id="user-dropdown" v-if="userMenuOpen"
					...
					<!-- BOUTON MOBILE -->
					<button class="md:hidden p-2 rounded hover:bg-gray-100" @click="mobileOpen = !mobileOpen">
		...
		<!-- CONTENU PRINCIPAL-->
		<div v-if="toast" class="mb-4 px-4 py-2 bg-green-600 text-white shadow">
			{{ toast }}
		</div>
		...
		<footer
			class="bg-white dark:bg-gray-800 border-t dark:border-gray-700 py-4 text-center text-gray-600 dark:text-gray-300 text-sm">
